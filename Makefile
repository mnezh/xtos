...
MSDOS_CFLAGS = -std=gnu89 -Wall -Wextra -Os -march=i8086 -mtune=i8086 -mmsdos -mcmodel=small
BUILD_DIR = build
FONT_EXE = $(BUILD_DIR)/font.exe
CONTROL_EXE = $(BUILD_DIR)/control.exe
SHOWCASE_EXE = $(BUILD_DIR)/showcase.exe
RUNTIME_SOURCES = runtime/app.c runtime/event.c runtime/display.c runtime/system.c runtime/text.c runtime/font.c runtime/canvas.c runtime/invalidation.c runtime/mouse.c runtime/cursor.c runtime/ui/form.c runtime/ui/label.c runtime/ui/list.c runtime/ui/button.c runtime/screen.c runtime/draw.c runtime/draw_cga.c runtime/draw_text.c runtime/cga.s runtime/keyboard.s runtime/mouse.s
FONT_SOURCES = runtime/fonts/font_4x6.c runtime/fonts/font_5x7.c runtime/fonts/font_5x8.c
FONT_VIEWER_SOURCES = $(FONT_SOURCES)

.PHONY: run-font run-control run-showcase clean docker-image
