...
RESIDENT_SOURCES = runtime/resident.c runtime/resident_dispatch.s runtime/resident_services.c runtime/resident_log.c runtime/resident_dos.s runtime/client.c runtime/event.c runtime/mouse.c runtime/cursor.c runtime/canvas.c runtime/draw.c runtime/draw_cga.c runtime/draw_text.c runtime/font.c runtime/runtime_form.c runtime/screen.c runtime/int60.s runtime/int60_call.s runtime/tsr.s runtime/cga.s runtime/keyboard.s runtime/mouse.s $(FONT_SOURCES)
